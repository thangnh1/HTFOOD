...
namespace HTFOOD.Forms
{
    public partial class Form_AddFood : Form
    {
        ...
        //kiem tra so luong nhap vao la so hay khong
        ...
        //kiem tra so luong nhap vao co trong khong
        ...
        {
            int rs = clP.Add(txtID.Text, 1, txtName.Text, txtNCC.Text, int.Parse(txtPrice.Text), int.Parse(txtDiscount.Text), int.Parse(txtNum.Text));
