...
{
    public partial class Form_SysFood : Form
    {
        public Form_SysFood()
        {
            InitializeComponent();
        ...
        private void Form_SysFood_Load(object sender, EventArgs e)
        {
            sttButton(true, false, false, false);
            dvwList.DataSource = clsPr.showList(1);
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DialogResult result = MessageBox.Show("Bạn có muốn xóa món ăn này ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
